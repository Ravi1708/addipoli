                    ...
                    <div className="container">
                        ...
                        <div class="order-complete-box">
                            <div className="cart-total-title">
                                ...
                                <h5>Order ID - <span>123456789</span></h5>
                            </div>
                            <div class="row">
                                <div class="col-md-8">                                                
                                        ...
                                        <div class="portfolioContainer row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 isotope-item breakfast">
                                                <div class="menu-list-order">
                                                    ...
                                                    <h5>Addipoli Puttu <span>$ 15.00</span></h5>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12 isotope-item lunch">
                                                <div class="menu-list-order">
                                                    ...
                                                    <h5>parotta with curry<span>$ 25.00</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4"> 
                                    ...
                                    <h6 className="heade-order">
                                        ...
                                        Near Landmark<br/>
                                        Mobile Number - 123456789</p>
                                    </h6>
                                </div>
                            </div>
                            <p>Thank you for ordering in our restaurant.
                                <br/> Now check a Food Tracker progress with your order.</p>
                            <a href="/track" class="btn-medium btn-primary-gold btn-large">Go To Food Tracker</a>
                        </div>
                    </div>
                </section>
            </div>
