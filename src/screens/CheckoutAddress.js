                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-4 col-sm-4 col-xs-12">
                                <div className="shop-checkout-left" data-wow-duration="1000ms" data-wow-delay="300ms">
                                    ...
                                    <form className="form" method="post" name="contact-form">
                                        <div className="row">                                            
                                            <div className="col-md-6 col-sm-6 col-xs-12">
                                                <label>Name*</label>
                                                <input name="" type="text" value={addressname}  required></input>
                                            </div>
                                            <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="col-md-12 col-sm-12 col-xs-12">
                                                <input name="submit" value="Add Address" className="btn-black pull-right send_message" type="submit"></input>
                                            </div>
                                        </div>
                                    </form>
                                </div>
